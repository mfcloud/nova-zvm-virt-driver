...
class ZVMDriver(driver.ComputeDriver):
    ...
    def __init__(self, virtapi):
        ...
        self._host_stats = self._get_host_status()
    ...
    def get_available_nodes(self, refresh=False):
        if self._host_stats == []:
            self._host_stats = self._get_host_status()
        return [self._host_stats['hypervisor_hostname']]
    ...
    def _get_image_info(self, context, image_meta_id, os_distro):
        ...
        if not spawn_image_exist:
            ...
            return self._sdkreq.call('image_query', imagename=image_meta_id)
        else:
